...
/**
 * Precompiled com.google.guava.java-conventions script plugin.
 **/
public class ComGoogleGuavaJavaConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ComGoogleGuavaJavaConventions").asSubclass(BasicScript.class);
