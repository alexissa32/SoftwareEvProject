...
Read below for our informal work and notes about how we set everything up and got to the point of actually analyzing the tools. A much better organized GitHub organization with our sample codebases, our build tool performance analyzer, and some results, can be found here: https://github.com/build-tool-analyzer
